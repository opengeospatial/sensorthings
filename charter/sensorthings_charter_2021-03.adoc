...
The planned work will rely upon the existing OGC Abstract Specification Topics. More specifically the following OGC standards will be taken account into the planned activities.
...
|Hylke van der Schaff |Fraunhofer iosb
|Marcus Alzona |Keys
