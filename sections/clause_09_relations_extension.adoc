...
The entity types, properties and relations added by this extension are partially depicted in <<img-sta-extension-relations>>.
For clairty, not all entities are depicted.
...
inherit:: {identifierSta}/req-class/datamodel/sensing/datastream
inherit:: {identifierSta}/req-class/datamodel/sensing/feature
inherit:: {identifierSta}/req-class/datamodel/sensing/location
inherit:: {identifierSta}/req-class/datamodel/sensing/observation
inherit:: {identifierSta}/req-class/datamodel/sensing/observedProperty
inherit:: {identifierSta}/req-class/datamodel/sensing/sensor
inherit:: {identifierSta}/req-class/datamodel/sensing/thing
...
| `ObservedPropertyRelations`
| The list of ObservedProperty-ObservedProperty relations that this RelationRole describes.
| `ObservedPropertyRelation`
| 0..*
...
=== Requirement Class: LocationRelation

A LocationRelation Entity relates a source Location to a target Location, or to an external resource, using a RelationRole.
...
====
[%metadata]
identifier:: {identifier}/req-class/datamodel/relations/locationrelation
obligation:: requirement
subject:: Target Type: Data Model
requirement:: {identifier}/req/datamodel/relations/locationrelation/properties
requirement:: {identifier}/req/datamodel/relations/locationrelation/relations
====
...
====
[%metadata]
identifier:: {identifier}/req/datamodel/relations/locationrelation/properties

Each LocationRelation entity SHALL have the mandatory properties and MAY have the optional properties listed in Table <<locationrelation-properties>>.
====
...
====
[%metadata]
identifier:: {identifier}/req/datamodel/relations/locationrelation/relations

Each LocationRelation entity SHALL have the direct relation between a LocationRelation entity and other entity types listed in Table <<locationrelation-relations>>.
====



[#locationrelation-properties,reftext='{table-caption} {counter:table-num}']
.Properties of a LocationRelation entity
[width="100%",cols="<3a,<20a,<3a,<",options="header"]
|====
| *Name*
| *Description*
...
[#locationrelation-relations,reftext='{table-caption} {counter:table-num}']
.Direct relation between a LocationRelation entity and other entity types
[width="100%",cols="<3a,<3a,<20a,<3a,<",options="header"]
|====
| *Source Entity Type*
| *Role*
...
| `LocationRelation`
| `Source`
| The source Location for this relation.
This is the inverse of `TargetLocationRelations`.
| `Location`
| 1

| `LocationRelation`
| `Target`
| The target Location for this relation.
This must be set if, and only if, the externalTarget property is not set.
This is the inverse of `SourceLocationRelations`.
| `Location`
| 0..1

| `Location`
| `TargetLocationRelations`
| The list of LocationRelation entities where this Location is the Source.
In other words, following this link leads to the Targets.
This is the inverse of `Source`.
| `LocationRelation`
| 0..*
...
| `Location`
| `SourceLocationRelations`
| The list of LocationRelation entities where this Location is the Target.
In other words, following this link leads to the Sources.
This is the inverse of `Target`.
| `LocationRelation`
| 0..*
...
=== Requirement Class: ObservedPropertyRelation

A ObservedPropertyRelation Entity relates a source ObservedProperty to a target ObservedProperty, or to an external resource, using a RelationRole.
...
====
[%metadata]
identifier:: {identifier}/req-class/datamodel/relations/observedpropertyrelation
obligation:: requirement
subject:: Target Type: Data Model
requirement:: {identifier}/req/datamodel/relations/observedpropertyrelation/properties
requirement:: {identifier}/req/datamodel/relations/observedpropertyrelation/relations
====
...
====
[%metadata]
identifier:: {identifier}/req/datamodel/relations/observedpropertyrelation/properties

Each ObservedPropertyRelation entity SHALL have the mandatory properties and MAY have the optional properties listed in Table <<observedpropertyrelation-properties>>.
====
...
====
[%metadata]
identifier:: {identifier}/req/datamodel/relations/observedpropertyrelation/relations

Each ObservedPropertyRelation entity SHALL have the direct relation between a ObservedPropertyRelation entity and other entity types listed in Table <<observedpropertyrelation-relations>>.
====



[#observedpropertyrelation-properties,reftext='{table-caption} {counter:table-num}']
.Properties of a ObservedPropertyRelation entity
[width="100%",cols="<3a,<20a,<3a,<",options="header"]
|====
| *Name*
| *Description*
...
[#observedpropertyrelation-relations,reftext='{table-caption} {counter:table-num}']
.Direct relation between a ObservedPropertyRelation entity and other entity types
[width="100%",cols="<3a,<3a,<20a,<3a,<",options="header"]
|====
| *Source Entity Type*
| *Role*
...
| `ObservedPropertyRelation`
| `Source`
| The source ObservedProperty for this relation.
This is the inverse of `TargetObservedPropertyRelations`.
| `ObservedProperty`
| 1

| `ObservedPropertyRelation`
| `Target`
| The target ObservedProperty for this relation.
This must be set if, and only if, the externalTarget property is not set.
This is the inverse of `SourceObservedPropertyRelations`.
| `ObservedProperty`
| 0..1

| `ObservedProperty`
| `TargetObservedPropertyRelations`
| The list of ObservedPropertyRelation entities where this ObservedProperty is the Source.
In other words, following this link leads to the Targets.
This is the inverse of `Source`.
| `ObservedPropertyRelation`
| 0..*
...
| `ObservedProperty`
| `SourceObservedPropertyRelations`
| The list of ObservedPropertyRelation entities where this ObservedProperty is the Target.
In other words, following this link leads to the Sources.
This is the inverse of `Target`.
| `ObservedPropertyRelation`
| 0..*
...
=== Requirement Class: SensorRelation

A SensorRelation Entity relates a source Sensor to a target Sensor, or to an external resource, using a RelationRole.
...
====
[%metadata]
identifier:: {identifier}/req-class/datamodel/relations/sensorrelation
obligation:: requirement
subject:: Target Type: Data Model
requirement:: {identifier}/req/datamodel/relations/sensorrelation/properties
requirement:: {identifier}/req/datamodel/relations/sensorrelation/relations
====
...
====
[%metadata]
identifier:: {identifier}/req/datamodel/relations/sensorrelation/properties

Each SensorRelation entity SHALL have the mandatory properties and MAY have the optional properties listed in Table <<sensorrelation-properties>>.
====
...
====
[%metadata]
identifier:: {identifier}/req/datamodel/relations/sensorrelation/relations

Each SensorRelation entity SHALL have the direct relation between a SensorRelation entity and other entity types listed in Table <<sensorrelation-relations>>.
====



[#sensorrelation-properties,reftext='{table-caption} {counter:table-num}']
.Properties of a SensorRelation entity
[width="100%",cols="<3a,<20a,<3a,<",options="header"]
|====
| *Name*
| *Description*
...
[#sensorrelation-relations,reftext='{table-caption} {counter:table-num}']
.Direct relation between a SensorRelation entity and other entity types
[width="100%",cols="<3a,<3a,<20a,<3a,<",options="header"]
|====
| *Source Entity Type*
| *Role*
...
| `SensorRelation`
| `Source`
| The source Sensor for this relation.
This is the inverse of `TargetSensorRelations`.
| `Sensor`
| 1

| `SensorRelation`
| `Target`
| The target Sensor for this relation.
This must be set if, and only if, the externalTarget property is not set.
This is the inverse of `SourceSensorRelations`.
| `Sensor`
| 0..1

| `Sensor`
| `TargetSensorRelations`
| The list of SensorRelation entities where this Sensor is the Source.
In other words, following this link leads to the Targets.
This is the inverse of `Source`.
| `SensorRelation`
| 0..*
...
| `Sensor`
| `SourceSensorRelations`
| The list of SensorRelation entities where this Sensor is the Target.
In other words, following this link leads to the Sources.
This is the inverse of `Target`.
| `SensorRelation`
| 0..*
