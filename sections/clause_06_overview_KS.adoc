...
Use of the OGC SensorThings API falls into two discrete groups:
...
The abstract API describes, in on an abstract level, how users can interact with the data model.
