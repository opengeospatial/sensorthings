...
The service SHALL respect the hint provided by the client (in Headers) to format the returned value for an entity modify request. The header structure depends on the specific protocol binding used in the communication (HTTP, MQTT)  
