...
* [[[OGC22-022r2,OGC SensorThings API Extension: STAplus 1.0.1]]], OGC, _OGC SensorThings API Extension: STAplus 1.0.1 corrigendum_, OGC (2026)
...
* [[[OGC21-045r1,OGC Features and Geometries JSON - Part 1: Core]]], OGC, _OGC Features and Geometries JSON - Part 1: Core_, OGC (2026), https://docs.ogc.org/is/21-045r1/21-045r1.html
