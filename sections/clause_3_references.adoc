...
* [[[OGC21-045r1,OGC Features and Geometries JSON - Part 1: Core]]], add:[OGC, _OGC Features and Geometries JSON - Part 1: Core_, OGC (2026), https://docs.ogc.org/is/21-045r1/21-045r1.html]
