...
| `definition`
| The URI linking the Sampler to an external definition.
| String
| 0..1
...
| `definition`
| The URI linking the SamplingProcedure to an external definition.
| String
| 0..1
...
| `definition`
| The URI linking the Sampling to an external definition.
| String
| 0..1
