...
NOTE: The OData specification uses the term property and properties. To avoid confusion with "ObservedProperties" and the "properties property", his document uses the terms attribute and attributes instead.
