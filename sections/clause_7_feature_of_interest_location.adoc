...
The implementation SHALL provide a JSON object in the `serverSettings` object on the landing page with the name `{identifier}/conf/geometry-wkt` that contains a property `default-crs` which value represents the default CRS identifier.
====
