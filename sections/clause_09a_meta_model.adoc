...
This Clause describes an overview of the types of entities in the metadata document that will be used to describe the SensorThings API data model and its data model extensions.
...
This was known as the `@selfLink` in SensorThings version 1.
|URL
