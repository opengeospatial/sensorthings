...
.Example {counter:examples}: Request for all Datastreams that have at least one Observation that has both a result greater than the threshold custom property in the containing Datastream, and a phenomenonTime after 2024-01-01 00:00:00Z
[source%unnumbered,text]
----
...
.Example {counter:examples}: Request for all Things that both have a Datastream measuring NO2 and a Datastream measuring O3
[source%unnumbered,text]
----
