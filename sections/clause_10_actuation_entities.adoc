...
If the metadata attribute is present, the encodingType must be specified.
...
The Actuator encodingType lets clients know how to interpret metadata's value(s).
