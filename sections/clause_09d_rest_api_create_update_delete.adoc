...
.Example of a request setting the ProximateFeatureOfInterest of `Datastream 1` to `Feature 2`.
[source,text]
----
replace http://host/service/Datastreams(1)/ProximateFeatureOfInterest/$ref
  {"@id": "Features(2)"}
----
...
.Example of a request removing the ProximateFeatureOfInterest from `Datastream 1`.
[source,text]
----
delete http://host/service/Datastreams(1)/ProximateFeatureOfInterest/$ref 
----
...
[source,text]
----
create http://host/service/Features(1)/FeatureTypes/$ref
  {"@id": "FeatureTypes(3)"}
----
...
[source,text]
----
replace http://host/service/Features(1)/FeatureTypes/$ref
  {"value": [
    {"@id": "FeatureTypes(1)"},
    {"@id": "FeatureTypes(2)"}
  ]}
...
[source,text]
----
delete http://host/service/Features(1)/FeatureTypes(2)/$ref
delete http://host/service/Features(1)/FeatureTypes/$ref?$id=../../FeatureTypes(2)
----
...
[source,text]
----
delete http://host/service/Features(1)/FeatureTypes/$ref
----
