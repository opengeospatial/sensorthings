...
The MQTT capability defined in this Standard allows del:[that] a client del:[receives] add:[to receive] changes del:[on] add:[to] STAplus entities via MQTT. 
...
For the entities defined in STAplus, a STAplus implementation SHALL support del:[the] receiving del:[of] entity updates with MQTT Subscribe as defined in http://www.opengis.net/spec/iot_sensing/1.0/req/receive-updates-via-mqtt.
====
...
For the entities defined in STAplus, a STAplus implementation SHALL support del:[the] receiving del:[of] entity updates with MQTT Subscribe as defined in http://www.opengis.net/spec/iot_sensing/1.1/req/receive-updates-via-mqtt.
====
