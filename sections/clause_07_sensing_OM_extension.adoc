...
| `encodingType`| The encoding type of the position property.
If the position attribute is present, the encodingType must be specified.
| IANA-MediaType
| 0..1
