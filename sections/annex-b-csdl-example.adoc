...
----
{
    ...
    "$EntityContainer": "org.OGC.STA.SensorThingsV2",  // Namespace + . + container name
    "org.OGC.STA": {         // Namespace
        "Datastream": {  // EntityType name
            ...
            "properties": {                 // Property properties
                "$Type": "org.OGC.STA.Object",  // custom type defined in org.OGC.STA namespace
                "$Nullable": true           // Nullable, thus Optional
            },
            "phenomenonTime": {               // Property phenomenonTime
                "$Type": "org.OGC.STA.TM_Period", // custom type defined in org.OGC.STA namespace
                "$Nullable": true             // Nullable, thus Optional
            },
            "Observations": {                   // Property Observations
                ...
                "$Type": "org.OGC.STA.Observation", // Target is of type Observation
        ...
        "Observation": {            // EntityType name
            ...
            "Datastream": {                    // Property Datastream linking to a single Entity
                ...
                "$Type": "org.OGC.STA.Datastream"  //  links to a Datastream
        ...
        "SensorThingsV2": {             // The entity container defining the base entity sets
            ...
            "Datastreams": {                     // The v2.0/Datastreams entitySet
                ...
                "$Type": "org.OGC.STA.Datastream",   // containing Datastreams
            ...
            "Observations": {                    // The v2.0/Observations entitySet
                "$Collection": true,             // is an entity set
                "$Type": "org.OGC.STA.Observation",  // containing Observations
...
{
    "$Version": "4.01",
    "$EntityContainer": "org.OGC.STA.SensorThingsV2",
    "org.OGC.STA": {
        "Datastream": {
            "$Kind": "EntityType",
            "$Key": [
            ...
            "ObservedProperties": {
                ...
                "$Collection": true,
                "$Partner": "Datastreams",
                "$Type": "org.OGC.STA.ObservedProperty",
                "$Nullable": true
            },
            "Sensor": {
                "$Kind": "NavigationProperty",
                "$Partner": "Datastreams",
                "$Type": "org.OGC.STA.Sensor"
            },
            "Thing": {
                "$Kind": "NavigationProperty",
                "$Partner": "Datastreams",
                "$Type": "org.OGC.STA.Thing"
            },
            "ultimateFeatureOfInterest": {
                "$Kind": "NavigationProperty",
                "$Partner": "Datastreams",
                "$Type": "org.OGC.STA.Feature",
                "$Nullable": true
            }
        },
        "Feature": {
        ...
        "Location": {
            ...
            "HistoricalLocations": {
                ...
                "$Collection": true,
                "$Partner": "Locations",
                "$Type": "org.OGC.STA.HistoricalLocation",
                "$Nullable": true
            },
            "Things": {
                "$Kind": "NavigationProperty",
