...
==== Root Page Discovery Requirements Class (mandatory)

According to <<OGC18088>> a compliant implementation returns a root page.

include::../requirements/requirement000.adoc[]
