...
. Check if the linked ObservedProperties match those referenced in the resultType attribute.
...
. Check if the content of the result attribute matches the structure defined in the resultType attribute of the linked Datastream
