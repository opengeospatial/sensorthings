[[ats_sta_websub_landing_page_topic_discovery]]
[abstract_test]
====
[%metadata]
...
[.component,class=step]
--
Validate the contents of the returned document to include the JSON object `https://www.opengis.net/spec/sensorthings-websub/1.0/conf/discovery` in the `serverSettings` including the key `topics_denied`. 
--
