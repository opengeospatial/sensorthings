...
[cols="a"]
|===
|Req <<req-bg>>: <<requirement-bg>>[[requirement-bg,create-update-delete/create-entity]]
...
[cols="a"]
|===
|Req <<req-bh>>: <<requirement-bh>>[[requirement-bh,create-update-delete/link-to-existing-entities]]
...
[cols="a"]
|===
|Req <<req-bi>>: <<requirement-bi>>[[requirement-bi,create-update-delete/deep-insert]]
...
[cols="a"]
|===
|Req <<req-bj>>: <<requirement-bj>>[[requirement-bj,create-update-delete/deep-insert-status-code]]
...
[cols="a"]
|===
|Req <<req-bk>>: <<requirement-bk>>[[requirement-bk,create-update-delete/update-entity]]
...
[cols="a"]
|===
|Req <<req-bl>>: <<requirement-bl>>[[requirement-bl,create-update-delete/delete-entity]]
