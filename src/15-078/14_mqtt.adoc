...
[cols="a"]
|===
|Req <<req-br>>: <<requirement-br>>[[requirement-br,create-observations-via-mqtt/observations-creation]]
...
[cols="a"]
|===
|Req <<req-bs>>: <<requirement-bs>>[[requirement-bs,receive-updates-via-mqtt/receive-updates]]
