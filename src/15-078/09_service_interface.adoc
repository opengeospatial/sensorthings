...
[cols="a"]
|===
|Req <<req-as>>: <<requirement-as>>[[requirement-as,resource-path/resource-path-to-entities]]
...
[cols="a"]
|===
|Req <<req-at>>: <<requirement-at>>[[requirement-at,request-data/status-code]]
...
[cols="a"]
|===
|Req <<req-au>>: <<requirement-au>>[[requirement-au,request-data/query-status-code]]
...
[cols="a"]
|===
|Req <<req-av>>: <<requirement-av>>[[requirement-av,request-data/order]]
...
[cols="a"]
|===
|Req <<req-aw>>: <<requirement-aw>>[[requirement-aw,request-data/expand]]
...
[cols="a"]
|===
|Req <<req-ax>>: <<requirement-ax>>[[requirement-ax,request-data/select]]
...
[cols="a"]
|===
|Req <<req-ay>>: <<requirement-ay>>[[requirement-ay,request-data/orderby]]
...
[cols="a"]
|===
|Req <<req-az>>: <<requirement-az>>[[requirement-az,request-data/top]]
...
[cols="a"]
|===
|Req <<req-ba>>: <<requirement-ba>>[[requirement-ba,request-data/skip]]
...
[cols="a"]
|===
|Req <<req-bb>>: <<requirement-bb>>[[requirement-bb,request-data/count]]
...
[cols="a"]
|===
|Req <<req-bc>>: <<requirement-bc>>[[requirement-bc,request-data/filter]]
...
[cols="a"]
|===
|Req <<req-bd>>: <<requirement-bd>>[[requirement-bd,request-data/built-in-filter-operations]]
...
[cols="a"]
|===
|Req <<req-be>>: <<requirement-be>>[[requirement-be,request-data/built-in-query-functions]]
...
[cols="a"]
|===
|Req <<req-bf>>: <<requirement-bf>>[[requirement-bf,request-data/pagination]]
