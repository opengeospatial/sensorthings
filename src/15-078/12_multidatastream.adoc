...
|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.0/req/<<requirement-multi-datastream-properties>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.0/req/<<requirement-multi-datastream-relations>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.0/req/<<requirement-multi-datastream-constraints>>
|===
