...
Special case #3: When the user tries to set a property of type Any to a value with a type the server does not support, the server must respond with HTTP status code 501 Not Implemented.
