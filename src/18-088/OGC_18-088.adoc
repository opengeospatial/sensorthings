...
|URL for this OGC(R) document: https://docs.ogc.org/is/18-088/18-088.html
|Additional Formats (informative): image:https://portal.ogc.org/images//fileicons/pdf.gif[link=https://docs.ogc.org/is/18-088/18-088.pdf]
