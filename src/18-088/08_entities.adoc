...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/entity-control-information
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/thing
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/location
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/historical-location
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datastream
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/sensor
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/observed-property
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/observation
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/feature-of-interest
