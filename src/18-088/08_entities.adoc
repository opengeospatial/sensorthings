...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datamodel/entity-control-information
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datamodel/thing

|Target Type
|Web Service

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-thing-properties>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-thing-relations>>
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datamodel/location

|Target Type
|Web Service

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-location-properties>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-location-relations>>
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datamodel/historical-location

|Target Type
|Web Service

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-historical-location-properties>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-historical-location-relations>>
...
[[req-create-update-delete-historical-location-manual-creation,{counter:req11}]]
[cols="a"]
|===
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datamodel/datastream

|Target Type
|Web Service

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-datastream-properties>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-datastream-relations>>
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datamodel/sensor

|Target Type
|Web Service

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-sensor-properties>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-sensor-relations>>
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datamodel/observed-property

|Target Type
|Web Service

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-observed-property-properties>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-observed-property-relations>>
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datamodel/observation

|Target Type
|Web Service

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-observation-properties>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-observation-relations>>
...
2+|\http://www.opengis.net/spec/iot_sensing/1.1/req/datamodel/feature-of-interest

|Target Type
|Web Service

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-feature-of-interest-properties>>

|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.1/req/<<requirement-feature-of-interest-relations>>
