...
|Requirement
|\http://www.opengis.net/spec/iot_sensing/1.0/req/<<requirement-batch-request-batch-request>>
...
POST /v1.0/Things(5)/Datastreams HTTP/1.1
Host: host
Content-Type: application/json
Content-Length: ###
