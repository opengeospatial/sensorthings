...
:committee: technical
:draft: 1.0
:external-id: https://www.opengis.net/spec/sensorthings-websub/1.0
:docnumber: 24-032r1
...
:keywords: ogcdoc, OGC document, OGC Standard, API, SensorThings, W3C, WebSub, MQTT, Webhook, Publisher, Subscriber, Hub
...
:local-cache-only:
:data-uri-image:
:pdf-uri: ./24-032r1.pdf
:edition: 1.0

:identifier: https://www.opengis.net/spec/sensorthings-websub/1.0
